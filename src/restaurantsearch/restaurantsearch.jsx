  ...
  return (
    <div className="searchcontentinnercontainer">
      <div className="searchcontentcontainer">
        ...
        <img
          className="searchrestaurantmap"
          src={testrestaurantmap}
          alt="Logo"
        />
        ...
        ㄴ<span className="searchparttag">이용 후기</span>
        <div className="restarantmenulist">
  ...
  const restaurants = [
    {
      ...
      opentime: "07:00",
      closetime: "22:00",
      loacation: "서울 동작구 사당로 10 지층 101호",
    },
    {
      restaurant_id: 2,
      name: "샐러데이즈 상도점",
    ...
    },
    {
      ...
      opentime: "11:00",
      closetime: "19:00",
      loacation: "서울 동작구 상도로 67길 27 3층",
    },
    {
      restaurant_id: 3,
      name: "우마이",
